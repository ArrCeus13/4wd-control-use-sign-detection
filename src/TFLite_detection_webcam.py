...
# Motor 2 (Left side)
in1_motor2 = 12  # Change this to the appropriate GPIO pin
in2_motor2 = 16  # Change this to the appropriate GPIO pin
en_motor2 = 25  # Change this to the appropriate GPIO pin

# Motor 3 (Right side)
in1_motor3 = 6  # Change this to the appropriate GPIO pin
in2_motor3 = 5   # Change this to the appropriate GPIO pin
en_motor3 = 26  # Change this to the appropriate GPIO pin

# Motor 4 (Right side)
in1_motor4 =27   # Change this to the appropriate GPIO pin
in2_motor4 = 22   # Change this to the appropriate GPIO pin
en_motor4 = 17  # Change this to the appropriate GPIO pin
...
def run_motor(motor, direction):
    if motor == 1:
        ...
        if direction == 'forward':
            ...
            GPIO.output(in1_motor4, GPIO.LOW)
            GPIO.output(in2_motor4, GPIO.HIGH)
...
while True:    
    ...
    for i in range(len(scores)):
        ...
        if ((scores[i] > 0.9) and (scores[i] <= 1.0)):
            ...
            # Perform actions based on detected object
            if object_name == 'kanan':
                print("kanan")
                temp1_motor1 = 1
                temp1_motor2 = 1
                temp1_motor3 = 1
